...
export default function ScheduleCalendar() {
    ...
    return (
        <div className='space-y-1'>
            <div className="p-0.5">
              ...
              <div className='text-xs truncate'>{event.extendedProps.courseCode}</div>
            </div>
              {room && <div className="text-xs opacity-70 truncate">{room}</div>}
        </div>
    )
  }
  ...
  return (
    <div className="w-full h-[70vh] overflow-hidden  bg-transparent">
      <FullCalendar
