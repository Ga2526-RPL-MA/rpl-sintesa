    ...
    return (
        <ol className="flex flex-col gap-6">
            ...
            <TutorialStep title="Enable Row Level Security (RLS)">
                <p>
                    Supabase enables Row Level Security (RLS) by default. To
                    query data from your <code>notes</code> table, you need to
                ...
                <p>
                    For example, you can run the following SQL to allow public
                    read access:
                </p>
                <CodeBlock code={rls} />
                <p>
