...
CREATE TABLE "schedule" (
	...
	"start_hour" "HOUR" NOT NULL,
	"end_hour" "HOUR" NOT NULL,
...
CREATE POLICY "Enable delete for users based on user_id" ON "course" AS PERMISSIVE FOR DELETE TO "supabase_admin" USING (true);--> statement-breakpoint
...
CREATE POLICY "Policy with table joins" ON "course" AS PERMISSIVE FOR UPDATE TO "supabase_admin";--> statement-breakpoint
CREATE POLICY "Enable delete for users based on user_id" ON "rooms" AS PERMISSIVE FOR DELETE TO "supabase_admin" USING (true);--> statement-breakpoint
...
CREATE POLICY "Enable read access for all users" ON "rooms" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
...
CREATE POLICY "Enable delete for users based on user_id" ON "lecturer" AS PERMISSIVE FOR DELETE TO "supabase_admin" USING (true);--> statement-breakpoint
...
CREATE POLICY "Enable read access for all users" ON "lecturer" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
