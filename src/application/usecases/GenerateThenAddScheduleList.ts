...
export default async function GenerateThenAddScheduleList(
    ...
    try {
        ...
        throw new Error(err instanceof Error? err.message : `Error: GenerateThenAddScheduleList(${scheduleListRepository},${courseRepository},${lecturerRepository},${roomRepository})`);
    }
}
